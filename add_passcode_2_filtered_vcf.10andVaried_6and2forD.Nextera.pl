...
open(FIN,"/volumes/neo/database/Nextera/NexteraRapidCapture_Exome_TargetedRegions_hg19_clean.bed") || die "can't open TruSeq-Exome-Targeted-Regions-BED-file.hg19.bed\n";
my $index="";
my %exome=();
while(<FIN>)
{
