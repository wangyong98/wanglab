...
$cmd="/volumes/neo/code/3rd_party/samtools-1.2/samtools view -uF 0x400 -q 1 $key.marked.sorted.bam | /volumes/neo/code/3rd_party/BEDTools-Version-2.14.3/bin/coverageBed -abam - -b /volumes/neo/database/IPTC/exons_coordinates.full.hg19.clean.bed -d >& $outfile";
system("$cmd");
